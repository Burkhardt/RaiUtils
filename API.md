...
- Recommended shared keys and variables: `OSLIB_CLOUD_ROOT_GOOGLEDRIVE`, `OSLIB_CLOUD_CONFIG`, and the `cloudstorage.ini` keys `dropbox`, `onedrive`, `googledrive` or `google_drive`, `icloud` or `icloud_drive`.
